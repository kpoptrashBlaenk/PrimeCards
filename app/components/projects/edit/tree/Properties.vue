<template>
  ...
  >
    <!-- Text -->
    <div v-if="'text' in projectStore.selectedComponent.properties" class="flex justify-content-between align-items-center">
      <projects-edit-tree-properties-label text="Text" tooltip="Text" />
      <projects-edit-tree-properties-text class="w-8" />
    </div>

    <!-- FontSize -->
    <div v-if="'fontSize' in projectStore.selectedComponent.properties" class="flex justify-content-between align-items-center">
      <projects-edit-tree-properties-label text="Font Size" tooltip="Font Size" />
      <projects-edit-tree-properties-font-size class="w-8" />
    </div>

    <!-- FontWeight -->
    <div v-if="'fontWeight' in projectStore.selectedComponent.properties" class="flex justify-content-between align-items-center">
    ...
    <!-- TextDecoration -->
    <div v-if="'italic' in projectStore.selectedComponent.properties" class="flex justify-content-between align-items-center">
    ...
    <!-- TextAlign -->
    <div v-if="'textAlign' in projectStore.selectedComponent.properties" class="flex justify-content-between align-items-center">
    ...
    <!-- LineHeight -->
    <div v-if="'lineHeight' in projectStore.selectedComponent.properties" class="flex justify-content-between align-items-center">
    ...
    <!-- Wrap -->
    <div v-if="'wrap' in projectStore.selectedComponent.properties" class="flex justify-content-between align-items-center">
      <projects-edit-tree-properties-label text="Wrap" tooltip="Wrap" />
      <projects-edit-tree-properties-wrap class="w-8" />
    </div>

    <!-- Cursor -->
    <div v-if="'cursor' in projectStore.selectedComponent.properties" class="flex justify-content-between align-items-center">
      <projects-edit-tree-properties-label text="Cursor" tooltip="Cursor" />
      <projects-edit-tree-properties-cursor class="w-8" />
    </div>

    <!-- Select -->
    <div v-if="'select' in projectStore.selectedComponent.properties" class="flex justify-content-between align-items-center">
    ...
    <!-- Padding -->
    <div
      v-if="'paddingLeft' in projectStore.selectedComponent.properties"
      class="flex justify-content-between align-items-center"
    >
      <projects-edit-tree-properties-label text="Padding" tooltip="Padding" />
      <projects-edit-tree-properties-padding class="w-8" />
    </div>

    <!-- Margin -->
    <div v-if="'marginLeft' in projectStore.selectedComponent.properties" class="flex justify-content-between align-items-center">
